...
Just follow the instructions of aflgo when starting fuzzing.
...
```shell
./benchmark/CVE-2016-4490/triage-crash-cve-2016-4490-cxxfilt.sh ./benchmark/CVE-2016-4490/cxxfilt-patched ./benchmark/CVE-2016-4490/cxxfilt-unpatch ./benchmark/CVE-2016-4490/cxxfilt-CVE-2016-4490/obj-dist/out/out_0/crashes 1
```
